...
namespace CritCompendium
{
    public sealed class ThemeManager
    {
        ...
        public ThemeManager(IDataManager dataManager)
        {
            ...
            Uri location = new Uri(@"/CriticalCompendium;component/Resources/Themes/Accents/Blue.xaml", UriKind.Relative);
            _blueAccent = (ResourceDictionary)Application.LoadComponent(location);

            location = new Uri(@"/CriticalCompendium;component/Resources/Themes/Accents/Green.xaml", UriKind.Relative);
            _greenAccent = (ResourceDictionary)Application.LoadComponent(location);

            location = new Uri(@"/CriticalCompendium;component/Resources/Themes/Accents/Orange.xaml", UriKind.Relative);
            _orangeAccent = (ResourceDictionary)Application.LoadComponent(location);

            location = new Uri(@"/CriticalCompendium;component/Resources/Themes/Accents/Purple.xaml", UriKind.Relative);
            _purpleAccent = (ResourceDictionary)Application.LoadComponent(location);

            location = new Uri(@"/CriticalCompendium;component/Resources/Themes/Accents/Red.xaml", UriKind.Relative);
            _redAccent = (ResourceDictionary)Application.LoadComponent(location);

            location = new Uri(@"/CriticalCompendium;component/Resources/Themes/Accents/Steel.xaml", UriKind.Relative);
        ...
        public void SetTheme(Theme theme)
        {
            ...
            if (theme == Theme.Dark)
            {
                location = new Uri(@"/CriticalCompendium;component/Resources/Themes/DarkTheme.xaml", UriKind.Relative);
            }
            else if (theme == Theme.Light)
            {
                location = new Uri(@"/CriticalCompendium;component/Resources/Themes/LightTheme.xaml", UriKind.Relative);
            }
            else if (theme == Theme.Parchment)
            {
                location = new Uri(@"/CriticalCompendium;component/Resources/Themes/ParchmentTheme.xaml", UriKind.Relative);
            }
